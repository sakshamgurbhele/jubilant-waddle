...
For companies with Greenhouse, the JSON API (`boards-api.greenhouse.io/v1/boards/{slug}/jobs`) returns clean structured data. Use as a fast complement to Level 1 — faster than Playwright but only works with Greenhouse.
...
- **Ashby**: `"Senior AI Engineer (Remote) @ Cohere"` → title: `Senior AI Engineer`, company: `Cohere`
- **Greenhouse**: `"ML Engineer at Anthropic"` → title: `ML Engineer`, company: `Anthropic`
- **Lever**: `"LLM Engineer - AI @ Mistral"` → title: `LLM Engineer - AI`, company: `Mistral`
...
https://...	2026-02-10	Ashby — AI Engineer	AI Engineer	Cohere	added
https://...	2026-02-10	Greenhouse — ML	Junior Dev	BigCo	skipped_title
https://...	2026-02-10	Ashby — AI Engineer	LLM Engineer	OldCo	skipped_dup
```
