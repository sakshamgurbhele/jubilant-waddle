...
Run exactly as in `offer` mode (read `modes/oferta.md` for all blocks A-F).

## Step 2 — Save Report .md
Save full evaluation in `reports/{###}-{company-slug}-{YYYY-MM-DD}.md` (see format in `modes/oferta.md`).
